...
import { Template, Root } from 'wikitext-dom';
  ...
  process( dispatch : any, dom : Root ) {
    ...
    dom.getChildrenByClassR( Template )
      ...
      .forEach( tpl => {
        ...
        doFillItemClaim( 'P31', 'Q2061228', oldValue =>
          oldValue && oldValue.id === ITEM_ID_LEGAL_INSTRUMENT ? toWikibaseEntityIdValue( 'Q2061228' ) : oldValue );

        // language <= Russian
        doFillItemClaim( 'P407', 'Q7737', null );
        // author <= President of Russia
        doFillItemClaim( 'P50', 'Q218295', null );
